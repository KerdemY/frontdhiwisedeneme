...
const MainpagematchtabPage = () => {
  ...
  return (
    <>
      <div className="min-h-screen bg-gray_900 flex sm:flex-col md:flex-col flex-row font-ggsans sm:gap-10 md:gap-10 gap-[295px] items-center mx-auto md:pr-10 sm:pr-5 pr-[242px] w-full">
      <aside className="min-h-screen bg-gray_900_01 flex flex-col md:hidden justify-between md:px-5 w-[361px]">
          <div
            className="common-pointer flex flex-row gap-[5px] items-center justify-start md:ml-[0] ml-[43px] mr-[87px] mt-[23px] w-[64%]"
            onClick={() => navigate("/")}
          >
            <Img
